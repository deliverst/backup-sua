...
if (process.env.OS === 'Windows_NT') {
    ...
    var pathDestination = `C:\\SW\\scripts\\backup-sua\\backups\\${year}_${month}_${day}.MDB` //todo: create folder backups automatically
...
// command to add schedule task on windows:
